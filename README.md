...
```mermaid
graph LR
    A[Homelab Router<br/>OpenWrt-based] --> B[Layered DNS Stack<br/>+ DoH]
    A --> C[Docker + Update Monitoring]
    D[ESPHome Devices] --> E[Home Assistant]
    E --> F[RF-Controlled Blinds]
    G[CachyOS + Hyprland] --> H[Windows 11 Dual-Boot]
    I[AZ-104 + Terraform] --> J[🎯 Cloud Engineering]
...
- LinkedIn: [linkedin.com/in/anil-gunduz](https://www.linkedin.com/in/anil-gunduz/)# Hi 👋, I'm Anıl
