...
```mermaid
graph LR
    A[FriendlyWRT / NanoPi R6S] --> B[DNS Stack: Dnsmasq → SmartDNS → DoH]
    A --> C[Docker + WUD]
    D[ESP8266 + CC1101] --> E[ESPHome]
    E --> F[RF-Controlled Roller Blinds]
    G[CachyOS + Hyprland] --> H[Secure Boot via sbctl]
    G --> I[Windows 11 Dual-Boot]
    J[AZ-104 + Terraform] --> K[🎯 Cloud Engineering]
    L[Snapmaker U1] --> M[3D Printing & Figure Painting]
```
...
- LinkedIn: [linkedin.com/in/anilgunduzz](#)
...
![Anıl's GitHub stats](https://github-readme-stats.vercel.app/api?username=anilgunduzz&show_icons=true&theme=dark)
-->
